...
# Title: HackRF FM Radio Receiver
# Author: spithash
...
class hackrf_fm_radio_receiver(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "HackRF FM Radio Receiver")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("HackRF FM Radio Receiver")
        ...
        self.settings = Qt.QSettings("GNU Radio", "hackrf_fm_radio_receiver")
        ...
        # Blocks
        ##################################################
        self._channel_freq_range = Range(87.9e6, 107.9e6, 10e3, 96.5e6, 200)
        ...
        self._audio_gain_range = Range(0, 10, 100, 1, 200)
...
def main(top_block_cls=hackrf_fm_radio_receiver, options=None):
